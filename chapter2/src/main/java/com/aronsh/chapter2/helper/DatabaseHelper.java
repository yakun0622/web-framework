 ...
 * ============================================================================
*/
package com.aronsh.chapter2.helper;

import com.aronsh.chapter2.annotation.Table;
import com.aronsh.chapter2.util.CollectionUtil;
...
//    }
     ...
     * @return
     */
    private static <T> String getTableName(Class<T> entitiy) {
        Table table = entitiy.getAnnotation(Table.class);
        if (table.value() == null) {
            return StringUtils.lowerCase(entitiy.getSimpleName());
        }
        return table.value();
...
//        }
    ...
    public static <T> boolean insertEntity(Class<T> entity, Map<String, Object> fieldMap) {
        if (CollectionUtil.isEmpty(fieldMap)) {
            LOGGER.error("can not insert entity: filedMaps is empty");
            return false;
        }
    ...
    public static <T> boolean updateEntity(Class<T> entity, long id, Map<String, Object> fieldMap) {
        if (CollectionUtil.isEmpty(fieldMap)) {
            LOGGER.error("can not update entity: filedMaps is empty");
            return false;
        }
